...
CREATE TABLE IF EXISTS Customers CASCADE;
CREATE TABLE IF EXISTS Credit_cards CASCADE;
CREATE TABLE IF EXISTS Course_packages CASCADE;
CREATE TABLE IF EXISTS Sessions CASCADE;
CREATE TABLE IF EXISTS Offerings CASCADE;
CREATE TABLE IF EXISTS Courses CASCADE;
CREATE TABLE IF EXISTS Rooms CASCADE;
CREATE TABLE IF EXISTS Owns CASCADE;
CREATE TABLE IF EXISTS Registers CASCADE;
CREATE TABLE IF EXISTS Buys CASCADE;
CREATE TABLE IF EXISTS Redeems CASCADE;
CREATE TABLE IF EXISTS Cancels CASCADE;
CREATE TABLE IF EXISTS Conducts CASCADE;
CREATE TABLE IF EXISTS Specializes CASCADE;
CREATE TABLE IF EXISTS Course_areas CASCADE;
CREATE TABLE IF EXISTS Pay_slips CASCADE;
CREATE TABLE IF EXISTS Employees CASCADE;
CREATE TABLE IF EXISTS Part_time_Emp CASCADE;
CREATE TABLE IF EXISTS Full_time_Emp CASCADE;
CREATE TABLE IF EXISTS Instructors CASCADE;
CREATE TABLE IF EXISTS Part_time_instructors CASCADE;
CREATE TABLE IF EXISTS Full_time_instructors CASCADE;
CREATE TABLE IF EXISTS Managers CASCADE;
CREATE TABLE IF EXISTS Administrators CASCADE;
